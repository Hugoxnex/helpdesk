"""
Help Desk SaaS - Sistema Multi-Tenant - VERSÃO CLOUD
Pronto para deploy em produção (Render, Railway, Heroku)
...
if IS_PRODUCTION:
    ...
    print("🌐 Rodando em PRODUÇÃO com PostgreSQL")
else:
    # Desenvolvimento: SQLite local
    os.makedirs(DATABASES_DIR, exist_ok=True)
    master_db_path = os.path.join(DATABASES_DIR, 'master.db')
    app.config['SQLALCHEMY_DATABASE_URI'] = f'sqlite:///{master_db_path}'
    print("🏠 Rodando em DESENVOLVIMENTO com SQLite")

# Upload folder
if IS_PRODUCTION:
    # Em produção, usar armazenamento temporário ou S3
    ...
    <head>
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
            ...
            .logo-section h1 { color: white; font-size: 28px; margin-bottom: 5px; }
...
def admin_panel():
        ...
        <style>
            * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
            ...
            .btn {
                ...
                font-size: 14px; font-weight: 600; cursor: pointer; border: none; margin-left: 10px;
            }
    ...
    <body>
        ...
        <div class="main-container">
            <div class="alert">✅ Sistema Multi-Tenant Funcionando!</div>
...
if __name__ == '__main__':
    ...
    if IS_PRODUCTION:
        ...
        print(f"🌍 Host: 0.0.0.0:{os.getenv('PORT', '5000')}")
    else:
        print(f"📊 Banco: SQLite ({DATABASES_DIR})")
    ...
    # Em produção, usar gunicorn (não rodar com app.run)
    if IS_PRODUCTION:
